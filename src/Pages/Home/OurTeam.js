  ...
  const ourTeam = [
    {
      ...
      role: "CTO",
      about: "Vincent Van Gogh’s most popular painting, The Starry Night.",
    },
    {
      name: "Marta Clermont",
      img: "https://images.pexels.com/photos/2381069/pexels-photo-2381069.jpeg?auto=compress&amp;cs=tinysrgb&amp;dpr=2&amp;h=750&amp;w=1260",
      role: "Student Support",
      about: "I love liquorice jujubes pudding croissant I love pudding.",
    },
    {
      name: "Andrew Larkin",
      img: "https://images.pexels.com/photos/3931603/pexels-photo-3931603.jpeg?auto=compress&amp;cs=tinysrgb&amp;dpr=2&amp;h=750&amp;w=1260",
      role: "Student Relation Executive",
      about:
        "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ratione quod eum temporibus ducimus at.",
    },
    {
      name: "Anthony Geek",
      img: "https://images.pexels.com/photos/2379004/pexels-photo-2379004.jpeg?auto=compress&amp;cs=tinysrgb&amp;dpr=2&amp;h=750&amp;w=1260",
      role: "Senior Instructor (Back End)",
      about: "Apple pie macaroon toffee jujubes pie tart cookie caramels.",
    },
    {
      name: "Alice Melbourne",
      img: "https://images.pexels.com/photos/3747435/pexels-photo-3747435.jpeg?auto=compress&amp;cs=tinysrgb&amp;dpr=2&amp;h=750&amp;w=1260",
      role: "Senior Instructor (Front End)",
      about:
    ...
    },
    {
      ...
      role: "Web Instructor",
      about:
        "Holisticly coordinate enterprise-wide results with extensible deliverables. Seamlessly redefine team driven information before one-to-one.",
    },
    {
      name: "Benedict Caro",
      ...
      role: "Instructor (Front End)",
      about:
        "Authoritatively build extensible partnerships whereas interactive action items. Efficiently pursue distinctive manufactured products with.",
    },
  ];
    ...
    <div className="">
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
          ...
          <h2
            className={`max-w-lg mb-6 text-3xl font-bold leading-none tracking-tight ${
              theme ? "text-slate-300" : "text-gray-900"
            } sm:text-4xl md:mx-auto font-montserrat`}
          >
          ...
          <p
            className={`text-base md:text-lg ${
              theme ? "text-slate-500" : "text-gray-700"
            }`}
          >
            Get to know the talented individuals behind our organization, each
            contributing their unique skills and passion to drive your mission
            forward.
          </p>
        </div>
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4 md:grid-cols-3">
            ...
            <div>
              <div className="relative overflow-hidden transition duration-300 transform rounded shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl">
                ...
                <div className="absolute inset-0 flex flex-col justify-center px-5 py-4 text-center transition-opacity duration-300 bg-black bg-opacity-75 opacity-0 hover:opacity-100">
                  <p className="mb-1 text-lg font-bold text-gray-100 font-montserrat tracking-wider">
                    {teamMember?.name}
                  </p>
                  <p className="mb-4 text-xs text-gray-100 font-montserrat font-semibold">
                    {teamMember?.role}
                  </p>
                  ...
                  <div className="flex items-center justify-center space-x-3">
                    <div className="">
                      <svg
                        viewBox="0 0 24 24"
                        fill="currentColor"
                        className="h-5 text-white hover:text-accent transition duration-300"
                      >
                    ...
                    <div className="">
                      <svg
                        viewBox="0 0 24 24"
                        fill="currentColor"
                        className="h-5 text-white transition duration-300 hover:text-accent"
                      >
