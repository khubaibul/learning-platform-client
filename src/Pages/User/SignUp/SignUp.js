                ...
                <form onSubmit={handleSignUp} className="p-12 md:p-24">
                    <div className="flex items-center text-lg mb-6 md:mb-8">
                        ...
                        <input type="text"
                            name="name"
                            required="required"
                            id="username" className="bg-gray-200 pl-12 py-2 md:py-4 focus:outline-none w-full" placeholder="Username Full Name" />
                    </div>
                    <div className="flex items-center text-lg mb-6 md:mb-8">
                        <img className="absolute ml-3" width="24" viewBox="0 0 24 24" src={photo} alt="" />
                        <input type="text"
                            name="photoURL" required="required"
                            id="username" className="bg-gray-200 pl-12 py-2 md:py-4 focus:outline-none w-full" placeholder="Photo URL" />
                    </div>
                    <div className="flex items-center text-lg mb-6 md:mb-8">
                        ...
                        <input type="email"
                            name="email"
                            required="required"
                            id="username" className="bg-gray-200 pl-12 py-2 md:py-4 focus:outline-none w-full" placeholder="Email" />
                    </div>
                    <div className="flex items-center text-lg mb-6 md:mb-8">
