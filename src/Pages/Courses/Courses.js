        ...
        <div className='lg:px-20 mt-20'>
            ...
            <div className='px-4 lg:hidden'>
                {
                    allCourses?.map(course => {
                        return <div key={course._id} className='flex'>
                            <Link to={`/course/${course._id}`} className='mb-2 w-full btn btn-outline btn-accent rounded-none'>
            ...
            <div className='grid grid-cols-5'>
                ...
                <div className='grid lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 lg:col-span-4 col-span-5 gap-4'>
                    {
                        allCourses.map(singleCourse => <SingleCourse key={singleCourse._id} singleCourse={singleCourse}></SingleCourse>)
                    }
                </div>
            </div>
        </div>
