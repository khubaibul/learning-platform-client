                    ...
                    <div className="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
                        <div>
                            ...
                            <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
                                <Link to="/about" className="hover:opacity-75" href> About </Link>
                        ...
                        <div>
                            ...
                            <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
                                <Link className="hover:opacity-75" href> Education </Link>
                                <Link className="hover:opacity-75" href> Online Edu </Link>
                                <Link className="hover:opacity-75" href> Courses </Link>
                                <Link className="hover:opacity-75" href> JOB Consulting </Link>
                                <Link className="hover:opacity-75" href> CSE Learning </Link>
                            </nav>
                        </div>
                        <div>
                            <p className="font-medium">
                            ...
                            <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
                                ...
                                <Link to="/faq" className="hover:opacity-75" href> FAQs </Link>
