...
const AuthProvider = ({ children }) => {
    ...
    const authInfo = { user, signInWithGoogle, signInWithGitHub, signInWithFacebook, createUser, loginUser, logOut, setLoading, loading, updateUserProfile, emailVerify, theme, setTheme }
    return (
